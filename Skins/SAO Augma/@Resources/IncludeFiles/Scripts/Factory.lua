...
Modifier = Ñ©ÔÂ»¨ (Setsukka)
Version = 
License = 
Information = Modified Name "function Initialize()" to "function Factory()"
				so that can be run at any time.
Source = Modified From "Factory.lua" Quoted By Skin
			"Lano Visualizer - Highly configurable visualizer"
			By MarcoPixel.
...
--[[
	Supplement By Modifier:
	
	Use [!CommandMeasure MeasureXXX "Factory()"] to run this script.
]]
